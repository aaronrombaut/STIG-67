...
Write-STIGRule "The ESXi host must display the Standard Mandatory DoD Notice and Consent Banner before granting access to the system via SSH."
...
foreach ($vmhost in $allVMhosts) {
    Get-VMHost -Name $vmhost |
     Get-AdvancedSetting -Name Config.Etc.issue |
