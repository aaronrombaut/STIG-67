...
$firewallRulesets = 
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "activeDirectoryAll"; "RulesetName" = "Active Directory All"},    
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "clusterAgentLearnerServer"; "RulesetName" = "clusterAgentLearnerServer"},
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "etcdClientComm"; "RulesetName" = "etcdClientComm"},
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "etcdPeerComm"; "RulesetName" = "etcdPeerComm"},
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "gstored"; "RulesetName" = "gstored"},
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "iSCSI"; "RulesetName" = "Software iSCSI Client"},
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "iwarp-pm"; "RulesetName" = "iwarp-pm"},    
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "ntpClient"; "RulesetName" = "NTP Client"},
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "ptpd"; "RulesetName" = "PTP Client"},
    ...
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "settingsd"; "RulesetName" = "settingsd"},
    ...
    @{"AllowedAll" = $false; "Enabled" = $true; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "trusted-infrastructure-kmxa"; "RulesetName" = "trusted-infrastructure-kmxa"},
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "trusted-infrastructure-kmxd"; "RulesetName" = "trusted-infrastructure-kmxd"},
    @{"AllowedAll" = $false; "Enabled" = $true; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "updateManager"; "RulesetName" = "vCenter Update Manager"},
    @{"AllowedAll" = $false; "Enabled" = $false; "IPAddress" = "192.168.0.0/16"; "RulesetID" = "vdfs"; "RulesetName" = "vdfs"},
...
foreach ($vmhost in $allVMhosts) {
    ...
    # Check if VMware ESXi Version is 7
    if($vmhost.Version -notlike "7.0.0") {
        Write-Host -NoNewline -ForegroundColor Red "Warning: "
        Write-Host "This host is not version 7.0.0!"
        Continue
    }
